...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="/web/css/for_restaurants.css" type="text/css">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
           ...
           <ul class="nav navbar-nav ml-auto w-100 justify-content-end">
              <li class="nav-item active">
               <a class="btn btn-space btn-primary" href="#" role="button">Get Restaurant App</a>
              </li>
              <li class="nav-item active">
               <a class="btn btn-space btn-primary" href="#" role="button">FAQ</a>
              </li>
           </ul>
        </div>
      </nav>
  ...
  <div class="container-fluid">
     <div id="main_background" class="row" >
        <!--image index background-->
        
        <div id="main_container" class="container">
        <div class="con_img">
          <img src="/web/img/fr_rest_mb.png" width="325px" height="550px" />
        </div> 
         <div class="text_instruction">
               <p>
                  <h2>
                      Increase your earnings with
                  </h2>
               </p>
               <p class="para">
                  <h2>
               ...
               <div class="para_2">
                  <p>
                    <h5 class="light-text">
                       We help restaurants to attract customers
                       by evolving their services.
                    </h5>
                  </p>
               </div>   
               <div class="become_partner">
                    <a  id="become_p" class="btn btn-space btn-primary" href="#" role="button"><font size="3">Add My Restaurant</font></a> 
               </div>
               <div class="para_3">
                  <p>
                    <h6 class="light-text">
                        Just send us your contact details, no obligations.<br>&#8377; 0 service fee during trial period.
                    </h6>
                  </p>
               </div> 
        </div>
         ...
         <div id="workflow" class="row">
           <div class="first col-sm-4">
               <div class="heading"><strong><h4>Serve better</h4></strong></div><div class="under_heading"><h6>Get ratings and reviews for your food
               so that you can serve better.</h6></div>
                </div>
           <div class="first col-sm-4">
           <div class="heading"><strong><h4>3 step process(for restaurants)</h4></strong></div><div class="under_heading"><h6>Get table and food reservations, send confirmation and prepare food on time.</h6></div>
          </div>
           <div class="first col-sm-4">
           <div class="heading"><strong><h4>Raising small restaurants</h4></strong></div><div class="under_heading"><h6>We provide small restaurants a platform where they can compete with big giants.</h6></div>
           </div>
      </div> 
